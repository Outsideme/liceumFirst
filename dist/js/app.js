(() => {
        ...
        accors.forEach((el => {
            el.addEventListener("click", (e => {
                ...
                if (!e.currentTarget.children[1].classList.contains("open-accor")) {
                    content.forEach((it => it.classList.remove("open-accor")));
                    self.add("open-accor");
    ...
    const showTableInQuarter = () => {
        if (tableIf.length > 0) if (new Date >= dateObj.startFirstQuarter && new Date <= dateObj.endFirstQuarter) {
            console.log("work?");
        ...
        } else if (new Date >= dateObj.startSecondQuarter && new Date <= dateObj.endSecondQuarter) {
            console.log("work?");
        ...
        } else if (new Date >= dateObj.startThirdQuarter && new Date <= dateObj.endThirdQuarter) {
            console.log("work?");
    ...
    document.querySelector(".reset-display-faculty");
