(() => {
    ...
    const menuObj = {
        ...
        headerResize: function() {
            ...
            if (null !== document.querySelector(".cate-leap__title")) if ("fixed" === cateLeapFix.style.position) cateLeapFix.style.top = `${headerHeight + 20}px`;
        },
    ...
    function mobileAccor() {
        ...
        accors.forEach((el => {
            el.addEventListener("click", (e => {
                document.querySelectorAll(".accor-icon");
    ...
    window.addEventListener("click", (e => {
        if (!e.target.closest(".header") && e.target !== input) topLineObj.closeSearch();
    }));
    ...
    function themeToggle() {
        ...
        if (null !== cateLeapBtnColor) {
            ...
            if (null !== document.querySelector(".cate-leap__content")) document.querySelector(".cate-leap__content").style.borderTop = "0px solid #000";
    ...
    function normalToggle() {
        ...
        if (null !== infraContentBox) {
            ...
            if (null !== document.querySelector(".cate-leap__content")) document.querySelector(".cate-leap__content").style.borderTop = "";
        }
        if (null !== cateLeapBtnColor) {
    ...
    document.querySelectorAll(".menu-link").forEach((elem => elem.classList.add("menu-links-hover")));
    document.querySelectorAll(".cat-leap-a").forEach((elem => elem.classList.add("menu-links-hover")));
    document.querySelectorAll(".span-cat-leap").forEach((elem => elem.classList.add("mine-link-static-right")));
    let oldScrollY = 0;
    function headerFix() {
        window.addEventListener("scroll", (function() {
            ...
            if (dY < 0) {
                ...
                if (null !== document.querySelector(".cate-leap__title")) {
    ...
    const cateLeapObj = {
        titleMargin: () => {
            if (null !== document.querySelector(".infra-title")) document.querySelector(".infra-title").classList.add("infra-titleNew");
        },
        removeTitleMargin: () => {
            if (null !== document.querySelector(".infra-title")) document.querySelector(".infra-title").classList.remove("infra-titleNew");
        },
        addOutClass: () => {
            if (null !== document.querySelector(".cate-leap")) cateLeapFix.classList.add("cate-leap-opacity");
        },
        removeOutClass: () => {
            if (null !== document.querySelector(".cate-leap")) cateLeapFix.classList.remove("cate-leap-opacity");
        },
        addCateFix: () => {
            if (null !== document.querySelector(".cate-leap")) cateLeapFix.classList.add("cateLeapFix");
        },
        removeCateFix: () => {
            if (null !== document.querySelector(".cate-leap")) cateLeapFix.classList.remove("cateLeapFix");
        }
    };
    headerFix();
